"use strict";var CACHE_NAME='1593523764';var urlsToCache=['/?utm_source=homescreen'];var idbDatabase;var IDB_VERSION=1593523764;var STOP_RETRYING_AFTER=86400000;var STORE_NAME='urls';function openDatabaseAndReplayRequests(){var indexedDBOpenRequest=indexedDB.open('offline-analytics',IDB_VERSION);indexedDBOpenRequest.onerror=function(error){console.error('IndexedDB error:',error);};indexedDBOpenRequest.onupgradeneeded=function(){this.result.createObjectStore(STORE_NAME,{keyPath:'url'});};indexedDBOpenRequest.onsuccess=function(){idbDatabase=this.result;replayAnalyticsRequests();};}
